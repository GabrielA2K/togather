  ...
  return (
    <>
      ...
      <section
        id="purpose"
        ref={purposeRef}
        className={"purpose" + (purposeInView ? " inview" : "")}
      >
        ...
        >
          ...
          <div className="icon-card-text">
            ...
            <p className="secondary">
              To support charities and other community interest organisations,
              particularly those within faith communities, educational
              institutions, and local community groups, by delivering a bespoke
              digital platform that streamlines operations, enhances
              communication, and fosters meaningful collaboration.
            </p>
          </div>
        </div>
        ...
        <div
          ref={visionRef}
          className={"icon-card vision " + (visionInView ? " visible" : "")}
          style={{ "--color": "#FFB81F" }}
        >
          <div className="icon-card-icon">
          ...
          <div className="icon-card-text">
            ...
            <p className="secondary">
              To build thriving, connected communities by providing inclusive,
              secure, and purpose-driven digital engagement platforms that
              empower faith-based, educational, and local organisations to
      ...
      <section
        id="activities"
        ref={activitiesRef}
        className={"activities" + (activitiesInView ? " inview" : "")}
      >
